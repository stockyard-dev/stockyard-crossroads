...
<title>Stockyard Crossroads</title>
<style>
  :root {
    --bg: #1a1410;
    --surface: #241c15;
...
<header>
  ...
  <span style="color:var(--cream);font-weight:600;">Crossroads</span>
  <span class="badge">v0.1.0</span>
</header>
<main>
  <div class="hero">
    <h1>Crossroads</h1>
    <p>Link-in-bio page builder — your domain, your data, no Linktree account</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">1 profile, 10 links</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited profiles and links</div>
