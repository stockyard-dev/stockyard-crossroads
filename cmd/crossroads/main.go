...
import (
	...
	"github.com/stockyard-dev/stockyard-crossroads/internal/license"
...
func main() {
	...
	licenseKey := os.Getenv("CROSSROADS_LICENSE_KEY")
	...
	log.Printf("Stockyard Crossroads listening on :%s (tier: %s)", port, tier)
